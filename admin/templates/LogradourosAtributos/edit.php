...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $logradourosAtributo->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $logradourosAtributo->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="logradourosAtributos form content">
            ...
            <fieldset>
                <legend><?= __('Edit Logradouros Atributo') ?></legend>
                <?php
