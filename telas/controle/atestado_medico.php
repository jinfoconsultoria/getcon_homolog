	...
	<div class="tab-pane fade show active" id="cadastro" role="tabpanel" aria-labelledby="cadastro-tab">
		...
		<div class="card" width="50%">
			...
			<div class="card-body">
				...
				<h4 class="card-title">Cadastrar um atestado</h4>
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<label for="data_vencimento-cadastro">Data de vencimento</label>

							<input class="form-control" type="date" id="data_vencimento-cadastro" />
...
<!-- <script src="../assets/js/uploader.js"></script> -->"nome-tipo" />
