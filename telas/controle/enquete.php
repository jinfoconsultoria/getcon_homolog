				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<label for="data_inicial-cadastro">Data inicial</label>

							<input class="form-control" type="date" id="data_inicial-cadastro" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<label for="data_final-cadastro">Data final</label>

							<input class="form-control" type="date" id="data_final-cadastro" />
